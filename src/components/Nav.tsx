...
const RESUME_URL = 'https://github.com/TiffOnTour83/tiffany-portfolio/Tiffany_Castro_International_Resume_2026_Updated.pdf'; // drop your resume PDF into the public/ folder
